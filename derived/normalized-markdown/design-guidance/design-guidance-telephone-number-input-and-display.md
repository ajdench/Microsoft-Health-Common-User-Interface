...
## Provenance
- Source file: `raw/sources/design-guidance/toolkit-bundled-pdfs/Design Guidance -- Telephone Number Input and Display.pdf`
- Extracted text: `derived/extracted-text/design-guidance/design-guidance-telephone-number-input-and-display.txt`
...
PREFACE
   ...
   Design Guidance – Telephone Number Input and Display                                                                            1.0.0.0
...
2    Recommendations and Guidance ................................................................................................5
    2.1    Telephone Number Display ......................................................................................................5
     2.1.1      Guidance .............................................................................................................................6
     2.1.2      Examples of Correct Usage.................................................................................................7
     2.1.3      Examples of Incorrect Usage ..............................................................................................7
     2.1.4      Rationale..............................................................................................................................8
    2.2    Telephone Number Input ..........................................................................................................9
     2.2.1      Unassisted Design .............................................................................................................10
     2.2.2      Assisted Design .................................................................................................................13

3    Document Information .................................................................................................................16
    3.1    Terms and Abbreviations ........................................................................................................16
    3.2    Nomenclature ..........................................................................................................................16
     3.2.1      Body Text...........................................................................................................................16
     3.2.2      Cross References ..............................................................................................................16
    3.3    References ..............................................................................................................................17
...
1             INTRODUCTION
    ...
    for the:
         ...
          Assessment of an input and display control for Telephone data in a clinical application user
           interface
         Important
    ...
    Deleted                              Reference to mobile telephone numbers (throughout document)

                                         Examples showing mobile telephone numbers (throughout document)

                                         Examples showing fax numbers (throughout document)

                                         Brackets around area codes (throughout document)

                                         Reference to extension number input box within incorrect usage examples (section 2.2.2.3)
 ...
 Change            IDs             Change Description
 Modified                          Guideline ID format changed from NID-nnnn to TID-nnnn (throughout document). This is to avoid
                                   confusion with guidelines in another Microsoft Health CUI document

                                   Text to reflect removal of brackets (throughout document)

                                   Fax numbers out of scope (section 1.2.2)

                                   Enhanced context setting for out of scope text (section 1.2.2)

                   TID-0010        Renumbered to TID-0011 and all subsequent IDs also incremented by one. This is to restore the
                                   integrity of the ID numbering scheme across Microsoft Health CUI documents.

                                   Correction to spelling of Afghanistan (section 2.2.2)

 Added                             Note acknowledging change in area codes from time to time (section 2.1)

                                   Expanded description of extension number display (section 2.1)

                   TID-0026        Extension number input box label

                                   Extension number input box prompt (section 2.2.1.1)

                                   Extension number input box tooltips (section 2.2.1.2)

                   TID-0027        Free text extension number input box

                                   Incorrect usage example (section 2.2.1.5)
...
1.1.1        Overview
 Telephone numbers display in various contexts within a clinical application, many of which are
 displayed within a clinical system. As such, it is an important requirement for both patient safety
 and general usability that each number can be easily recognized as unique, in order to reduce
...
1.1.2        Eliminating Inconsistencies Across Systems
 Significant inconsistencies exist across the labeling, inputting, and displaying of telephone numbers
 across various clinical applications. With clinical users often switching between applications, these
 inconsistencies can lead to the incorrect identification of patients, which in turn, leads to safety
 issues. Reduction of inconsistency is therefore an important goal in itself and the primary aim of
 this guidance.
...
1.2.2        Out of Scope
 ...
 The following items are out of scope:
      ...
       Data input control types – This document does not specify how the input controls should
        be labeled, for example, ‘Home number’ or ‘Preferred contact’. The concept of types and
...
1.3      Key Principles
 The following key principles have shaped the guidance in this document:
      ...
       Minimize opportunities where patient-clinician relationships may be compromised
...
2.1           Telephone Number Display
    This section defines the recommendations for displaying telephone numbers in clinical applications.
    Clinical applications should display telephone numbers in this format to facilitate contact by
    telephone with patients, clinicians, hospitals or surgeries.
    ...
    optional digits.
           Note
           It is recognized that most telephone numbers stored within clinical applications will relate to UK locations.
           In these cases, the international code element is not required.

    1
        Ofcom – Office of Communications {R1}: http://www.ofcom.org.uk/
    2
        UK Government Data Standards Catalogue {R2}: http://www.govtalk.gov.uk/gdsc/html/
    3
        Microsoft Corporation {R3}: http://www.microsoft.com/en/us/default.aspx
    4
        IBM Corporation {R4}: http://www.ibm.com/us/
    5
        Dell {R5}: http://www.dell.com
                                                                                                                   Page 5
                                Design Guidance – Telephone Number Input and Display
                                Prepared by Microsoft, Version 2.0.0.0
                                Last modified on 28 January 2010

 Telephone numbers in clinical applications can comprise up to four elements, are separated by
 spaces and are displayed in the following order:
      ...
       Extension Number (optional) – Is validly represented by either:
                A single input box including an ‘x’ character displayed directly after the telephone
                 ...
                 +International Code Area Code Local Number xExtension Number
                Display in a separate extension input box adjacent to the telephone number input box
                 The full telephone number then displays as:
                 +International Code Area Code Local Number [Extension Extension Number]
...
2.1.1           Guidance
 ...
 TID-0004           When displayed, the country code must be separated from the rest of the telephone number by       Mandatory
                    a single space.

 TID-0005           For UK telephone numbers, the area code must not be displayed with brackets around it.            Mandatory

 TID-0006           For UK telephone numbers, the area code must be separated from subsequent numbers by a            Mandatory
                    space.
 ...
 ID                 Guideline                                                                                       Status
 TID-0007           For UK telephone numbers, extension numbers can be displayed with an ‘x’ preceding and          Recommended
                    adjacent to the number.

 TID-0008           For UK telephone numbers where the telephone and extension numbers are displayed within a Mandatory
 ...
 TID-0026           For UK telephone numbers where the extension number is displayed in a separate input box, a     Recommended
                    label must be shown above the input box to indicate the content

 TID-0009           For UK telephone numbers, if there are more than six digits in the local number, (in other words, Mandatory
...
2.1.2        Examples of Correct Usage
  Usage Format                                             Examples                Comments
   ...
           <space> Local Number [‘x’ Extension                                    within a clinical application.
                                                           0151 496 0947
            Number]
                                                           01632 960326
...
2.1.3        Examples of Incorrect Usage
  Usage Format                                             Examples                Comments
            [International Code <space>] Area Code         (029) 2018 0928         Examples incorrectly shown with brackets around
           <space> Local Number                                                   the area codes.
                                                           (0151) 496 0947
            Where optional digits are omitted              (01632) 960326
                                                           (01632) 96029
                                                           (016329) 60541
                                                           (016329) 6054

            International Code <space> Area Code           +44 029 2018 0928       This example lacks clarity because there is no
           <space> Local Number                                                   distinction between optional and mandatory digits
                                                           +44 0151 496 0947
  ...
  Usage Format                                              Examples           Comments
     ...
            <space> Local Number                                              international code for the UK, and the leading zero
                                                            +44 151 496 0947
...
2.1.4         Rationale
  ...
  recommended grouping follows commonly-used conventions and thus aids recognizability for the
  user.

2.1.4.1           Accessibility
  The inclusion of the international and area codes assists with the unique recognition of telephone
  number formats from other countries. The plus sign provides a clear indication that the value
...
2.1.4.2            Patient Safety
  A Telephone number display affects patient safety when it appears in close proximity to the patient
  identification number within a screen. In such cases, the numbers could be confused, resulting in
  the user accessing the wrong patient record details. Therefore, the format of each number should
  provide a clear distinction between the relevant value types. Figure 5 illustrates an example, taken
  from the UK National Health Service (NHS), showing a telephone number that is in close proximity
  to the patient identification number (‘NHS Number’):

                                                                                                        
  Figure 5: Example of a Telephone Number Format in Close Proximity to a Patient Identification Number

  Patient identification numbers should display as groups of digits, separated by single spaces.
  Telephone numbers should exhibit formats that clearly distinguish them from associated patient
  identification numbers. This can be achieved easily by preceding the optional international code
  with a plus sign (‘+’).

2.1.4.3            Clinical Utility
  A user should view telephone number information in a consistent format, with a recognizable
  ...
  displayed in all instances, there will never be a need to look up secondary sources for extra dialing
  codes. However, most telephone numbers stored within clinical applications will relate to UK
  ...
  distinguishes telephone numbers from other numerical information, such as dates and patient
  identification numbers.

2.1.4.4            Display Space
  Telephone numbers display in various contexts within a clinical application. From an application
...
2.2.1        Unassisted Design
 ...
 The telephone number input box should reformat the number entered, so as to enhance readability.
 The basic principles are as follows:
      The Input box should accept formatted and unformatted entries
             If the number can be identified as a valid type, the input box should strip out formatting
              upon losing focus and replace it with a reformatted equivalent that places spaces in
              logical locations for readability purposes
      If the number cannot be identified as a valid type then:
     ...
      The UK country code can be entered but is removed from display after it has been
       committed
      All other country codes are retained
 Additionally, extension numbers should be identified and displayed, as follows:
     ...
     1. Identify if the number has any of the following characters or sequence of characters in it,
        followed by a sequence of digits:
         ...
             ‘extension’
           ...
                ‘extension number’
                Any of the above, followed by one of the following:
                  A full stop ‘.’
                  A colon ‘:’
                  An ‘equals’ character ‘=’
                  A hyphen ‘-‘
     2. If so, then:
           a. Remove the identified characters and replace with an ‘x’.
           b. Remove the ‘x’ with any subsequent digits and only replace them at the end of the
              telephone number.
...
2.2.1.3           Guidance
  ...
  TID-0013            If the number can be identified as a valid type, the input box should strip out formatting upon   Mandatory
                      losing focus and replace it with a reformatted equivalent.
  ...
  TID-0015            If the number cannot be identified as a valid type, display the entry to the user as it was          Mandatory
                      entered.
...
2.2.1.4           Examples of Correct Usage
  Usage Format                                 Examples                                                Comments

            A single free-text input box                                                              The user should be able to input
             design                                                                                    whatever data value they feel is most
                                                                                                       appropriate.

            Can identify and reformat                                                                 The input should intelligently
             telephone numbers                                                                         reformat for readability.

            Can identify and reformat                                                                 The input box should be able to
             telephone numbers with                                                                    handle extension numbers.
             extensions

            Can identify and reformat          Telephone Number               Extension               An extension number may be
             telephone number with                                                                     displayed using a separate input box
                                                 0118 909 8765                  1234
             extension number displayed
             in separate input box
  Table 6: Correct Examples of Unassisted Telephone Number Input

2.2.1.5           Examples of Incorrect Usage
  Usage Format                                 Examples                                                Comments

            Separate input box for area                                                               A separate input box for the area
             code                                                                                      code can cause users to incorrectly
                                                                                                       guess the area code.

            Number input reformatted                                                                  Brackets are shown around the area
                                                                                                       code on a formatted number.
...
2.2.2         Assisted Design
  ...
  the user in selecting the correct dialing code for non-UK telephone numbers, by presenting the user
  with a list box of known dialing codes, at the time of creation.
...
2.2.2.1            Guidance
  ...
  TID-0021             Use the International Organization for Standardization (ISO) standard ISO 31666 names in the     Mandatory
                       first column, the Ofcom list of dialing codes in the second column and the two-letter ISO 3166
                       abbreviated country codes in the third column. Use the abbreviation ‘UK’ instead of the ISO
                       3166 code of ‘GB’.

  TID-0022             Order the country names alphabetically.                                                          Mandatory
  ...
  TID-0025             Populate the country selector list with the three elements below and in this exact order:        Recommended
                       1. Country name (left-aligned and vertically aligned to all rows).
                       2. Country dialing code (right-aligned using the '+' format, for example, ‘+44').
  ...
  6
   International Organization for Standardization ISO 3166-1: 2006: English country names and code elements {R6}:
...
2.2.2.2           Examples of Correct Usage
  Usage Format                              Examples                              Comments

            Default selection is the for                                         The user is only required to interact with the
             UK                                                                   country selector if it is a non-UK number.

            Drop-down list to assist                                             A drop-down list of all the valid values assists
             country selection                                                    the user in correctly identifying the number
                                                                                  they need.

            Alphabetical listing of                                              Alphabetizing the country selector list assists
             countries (with UK                                                   the user in finding the data they require.
             duplication exception)                                               Because ‘UK’ is expected to be the primary
                                                                                  selection of users, it is duplicated for
                                                                                  convenience.

  Table 9: Correct Examples of Assisted Telephone Number Input

2.2.2.3           Examples of Incorrect Usage
  Usage Format                              Examples                              Comments

            Use of separate inputs for                                           The use of separate input boxes increases
             area code                                                            screen clutter and the likelihood of input error.

            Country Code input                                                   The button input design does not suggest to
             mechanism that does not                                              the user that they can type a selection here. It
             allow free-text input or                                             does not display the numerical country code
             display the country code                                             and so increases the likelihood of a user
                                                                                  committing a duplication error by inputting the
                                                                                  country code in the second input box. Finally,
                                                                                  the user cannot check the full numerical
                                                                                  number because they cannot see the country
                                                                                  code.
...
2.2.2.4           Rationale
  ...
  required country code, they can select it from the alphabetized list. If they do know the country
  ...
  alphabetized list, which ensures the user finds what they are searching for.

2.2.2.5           Text Input Box
...
3.3       References
 ...
 R1.               Ofcom – Office of Communications:
                   http://www.ofcom.org.uk/

 R2.               UK Government Data Standards Catalogue:
 ...
 R6.               International Organization for Standardization ISO 3166-1: 2006: English country names and code
                   elements:
                   http://www.iso.org/iso/country_codes/iso_3166_code_lists/english_country_names_and_code_element
                   s.htm
 Table 14: References
