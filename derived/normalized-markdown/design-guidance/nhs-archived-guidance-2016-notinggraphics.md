...
## Provenance
- Source file: `raw/sources/design-guidance/nhs-archived-guidance-2016/notinggraphics.pdf`
- Extracted text: `derived/extracted-text/design-guidance/nhs-archived-guidance-2016-notinggraphics.txt`
...
Amendment History:
   ...
   Tim Chearman               Approved by FileCM     CUI CAPS Project Manager       20 October 2010          V1.0
                              workflow

   John McDermott             Approved by FileCM     CUI CAPS UI Designer           20 October 2010          V1.0
                              workflow

   Lindsey Butler             Approved by FileCM     CUI CAPS Nurse Advisor         20 October 2010          V1.0
                              workflow               and Clinical Safety Advisor

   Meg Thomas                 Approved by FileCM     CUI CAPS UI Designer           20 October 2010          V1.0
                              workflow
   ...
   Steve Bentley            Approved by FileCM     Senior Clinical Consultant      15 November 2010          V1.0
                            workflow
...
Patient Safety Process
   ...
   Refer to NHS Common User Interface for further information on the patient safety process and for the safety
   status and any relevant accompanying safety documentation for this design guide.

Copyright:
You may re-use this information (excluding logos) free of charge in any format or medium,
under the terms of the Open Government Licence. To view this licence, visit
nationalarchives.gov.uk/doc/open-government-licence or email
...
address: cuistakeholder.mailbox@hscic.gov.uk.
...
5         Guidance Points Checklist 51
...
Noting with Graphics module
   This section details the general guidance for the Noting with Graphic module as a whole.
       ...
       When the graphic is loaded for creation or editing
       purposes, display both the canvas (containing the graphic)
       and the toolbar
       Rationale: the user will need the tools and functions offered by the toolbar to
       manipulate the annotated graphic
...
HSCIC Controlled Document
       ...
       When the graphic is loaded for viewing purposes, display
       only the canvas (containing the graphic and notes) and not
       the toolbar
      ...
      by the toolbar
       ...
       When the graphic is loaded for viewing purposes, do not
       allow the user to edit or change any part of the annotated
       graphic
      ...
      Position the Noting with Graphics module in the relevant                                   Page 9

      clinical notesCopyright
                    section ©2013 Health and Social Care Information Centre
...
HSCIC Controlled Document
      ...
      The workflow involved in creating an annotated graphic
      should allow the user to firstly display the desired graphic,
      then allow the addition of any annotating symbols and then
      finally the adding of any annotating text
      ...
      Where the Noting with Graphics module is not displayed
      fully on screen, ensure that the application hosting it
      provides scrolling to enable the user to view the entire area
      ...
      When a previously annotated graphic is loaded for viewing
      purposes, display all the added annotations in the same
      way as when the graphic was created
   ...
   when the graphic was being created remains the same when the graphic is being
Graphics
   viewed
   ...
   module.
      ...
      NwG-0001 - Mandatory
                                                                                                             Page 10
      The graphic should be a simple, lined-based image. It
...
HSCIC Controlled Document
      ...
      The graphic should only be in greyscale. Coloured graphics
   ...
   In this correct example the graphic is a greyscale        In this incorrect example the graphic includes
   outline image (NwG-0001, NwG-0002)                        different colours and shades. It also contains
...
HSCIC Controlled Document
      ...
      Include a title on each displayed graphic where there is the
      ...
      choosing the wrong one (e.g. left hand and right hand)
                                                                            ...
                                                                            Include orientation labels on graphics w
                                                                            chance of mixing up the orientation
                                                                            Rationale: orientation labels (e.g. ‘front view’ and ‘back
                                                                            safety issue occurring where a user chooses or annotat
                                                                            the graphics look very similar (e.g. a graphic of the left h
                                                                            right hand)
      NwG-0004 - Recommended

      Where the clinical context requires it, display the correct
      graphic taking into account the age of the patient (e.g.
                                                                                                             Page 12
      display either an adult, teenager, child, infant or baby
      graphic)          Copyright ©2013 Health and Social Care Information Centre
...
HSCIC Controlled Document
       ...
       Where the clinical context requires it, display the correct
       graphic taking into account the sex of the patient (e.g.
       display either a male or female graphic)
      Rationale: to provide a graphic that more realistically depicts the patient currently
      being seen by the clinician. This allows clinicians to more accurately record their
      findings
      ...
      When opened in the canvas, the graphic should be
      displayed at a suitable size to remove the need for the user
      having to firstly re-size it
      ...
      manipulations to it (i.e. re-size, zoom etc)

      NwG-0009 – Mandatory

      Do not include background lines or grids as part of the
      graphic
      Rationale: both research and patient safety assessments have shown that it is
      possible for users to easily mistake background lines or grids as segments drawn on a
      body image (e.g. segments drawn onto an abdomen graphic)
                                                                                              Page 13
...
HSCIC Controlled Document
   ...
   In this correct example no lines nor grids are          In this incorrect example the graphic includes a
   included as part of the graphic (NwG-0009)              grid (NwG-0009)

      NwG-0006 – Recommended

      Where a graphic is made up of 2 or more separate images
      (e.g. a full-body graphic made up of a front and rear body
      image) then provide space for the user to add text
      annotations between the images
      Rationale: this is because research has shown that clinicians do sometimes need to
      put a single text annotation between two images and refer it to both images
                                                                                                         Page 14
...
HSCIC Controlled Document
   ...
   In this correct example no part of the           In this incorrect example part of the
   original graphic has been – or is able to        graphic has been deleted by the user
   be – deleted by the user (NwG-0010)              (NwG-0010)
...
HSCIC Controlled Document
      ...
      ensure that the location of any items already annotating the
      graphic is correctly retained
      ...
      well otherwise it will no longer be on the left-shoulder
...
HSCIC Controlled Document
   ...
   In this correct example no lines nor                         In this incorrect example a grid is displayed
   grids are shown on the canvas (NwG-                          on the canvas (NwG-0089)
   0089)
...
HSCIC Controlled Document
      ...
      Leave sufficient room for adding annotating text to both the
      left and right side of the graphic
      ...
      NwG-0007 – Recommended

      Do not leave room above or below the graphic for text
      annotating                                                                                Page 20

      Rationale: research has shown©2013
                        Copyright   that users tendand
                                          Health    to write
                                                       SocialonCare
                                                                the left or the rightCentre
                                                                     Information      side of
      the graphic – and not above or below it

HSCIC Controlled Document

   Usage Examples

   In this incorrect example room has been left                In this incorrect example room has been left
   above the graphic for annotation purposes                   below the graphic for annotation purposes
   (NwG-0007)                                                  (NwG-0007)
      ...
      NwG-0081 – Mandatory
                   Copyright ©2013 Health and Social Care Information Centre
      Any colour chosen   for the canvas background should not
      reduce the readability or clarity of the graphic, or any

HSCIC Controlled Document

      NwG-0099 – Mandatory

      A canvas can never be empty or blank – it must always
      contain a graphic
      ...
      The canvas should be sufficiently sized to contain the
      graphic without the user needing to scroll or zoom to view
      the entire graphic
      ...
      The canvas should automatically grow in length when
      additional room for text or symbol annotations is required
      Rationale: the canvas must offer more room for extra annotations to prevent the
      user having to scroll within the canvas

      NwG-0100 – Mandatory

      Do not allow the graphic or annotating items to be placed
...
HSCIC Controlled Document
   ...
   canvas to provide horizontal scrolling (NwG-0102)
      ...
      Where the canvas is not displayed fully on screen, ensure
      that the 'look ahead' identifier is shown to indicate that not                 Page 25
      all content is currently being displayed
                        Copyright ©2013 Health and Social Care Information Centre
      Rationale: the look-ahead identifier provides a visual clue to the user that
      annotations are off screen
...
Loading and Searching for a Graphic
   ...
   choose which graphic they want to load from a small set of offered graphics.
      ...
      Where the clinical context requires it, the canvas containing
      a graphic should be automatically loaded in the relevant
      location in the clinical notes without requiring any user
      intervention
      ...
      Where the clinical context requires it, provide the user with
      an option to load a graphic in the relevant location in the
      ...
      Where the clinical context requires it, provide a way for the                                      Page 27

      user to choose and load the appropriate graphic for the
                   Copyright ©2013 Health and Social Care Information Centre
...
HSCIC Controlled Document
      ...
      Where the clinical context allows it, provide the user with a
      mechanism that allows them to remove the entire Noting
      with Graphics module if they decide that they do not want
      to use a graphic within the clinical notes
...
HSCIC Controlled Document
      ...
      Where the clinical context requires it, present the user a
      short list of commonly used graphics to choose from when
      required
      ...
      Where the clinical context requires it, allow as a secondary
      way of choosing a graphic the user to perform a simple text-
...
HSCIC Controlled Document
      ...
      Where different ways of selecting or searching for a graphic
      are implemented, ensure that they are visually distinct and
      separate from each other on screen
...
HSCIC Controlled Document
      ...
      Provide free-hand drawing tools that allow the user to
      annotate the graphic by drawing on it the relevant clinical
      findings
      ...
      symbol would not be easily possible
...
HSCIC Controlled Document
      ...
      Where   clinical
      NwG-0029 –       finding symbols are very common or
                 Mandatory
      regularly  used,finding
      Where clinical    providesymbols
                                the userare
                                         with  a ready-made
                                            difficult          symbol
                                                      to draw free-
      to addprovide
      hand,  to the graphic
                       the user with a ready-made symbol that can
      be  simply
      Rationale:     added
                 so that      to does
                         the user the not
                                      graphic
                                          have to spend time and effort hand-drawing
      ...
      The ready-made symbols available for annotating should be
      relevant to the graphic that has been loaded
      ...
      Provide an easily understood and intuitive way of adding
      the ready-made symbols to the graphic
      Rationale: research has shown that users have a preference for adding ready-made    Page 32
      symbols using a straightforward and intuitive way (e.g. drag-and-drop or a single
                        Copyright
      mouse-click and the  symbol is©2013
                                     placed Health and Social Care Information Centre
                                            on the canvas)
...
HSCIC Controlled Document
   ...
   mouse to drag the item to the desired location (NwG-0031)
      ...
      Ensure that any ready-made symbols provided are correctly
      sized for the graphic they are to be placed on top off
...
HSCIC Controlled Document
   ...
   In this correct example the ready-made                        In this incorrect example the ready-
   symbol is appropriately sized for the                         made symbol is too large for the
   underlying graphic (NwG-0111)                                 underlying graphic it is placed on (NwG-
                                                                 0111)

      NwG-0033 – Mandatory

      Provide the user with a small set of ready-made symbols -
      limited to only those that are commonly used
      ...
      Provide a ready-made symbol to indicate an exact location
      on the graphic
      ...
      preference for using an ‘X’ symbol to indicate a specific location

                                                                                                            Page 34

      NwG-0034 – Mandatory
                    Copyright ©2013 Health and Social Care Information Centre
      Provide a free-hand drawing or shading tool to indicate a
      region or spread-out area

HSCIC Controlled Document

      NwG-0105 – Mandatory

      Ensure that the ready-made symbols provided look visually
      different and are distinguishable from all other items within
      the canvas
      Rationale: to prevent the risk that the user misinterprets or does not recognise a
      ...
      Ensure that when used the hand-drawn symbols provided
      look visually different and are distinguishable from all other
      ...
      Allow the user to make free-hand drawings outside of the
      graphic perimeter (but still within the canvas)
      ...
      drawing on top of and around it

      NwG-0040 – Mandatory
                                                                                                Page 35
      Enable the user to be able to reposition a symbol that they
      have added to      Copyright  ©2013 Health
                           the graphic              and Social
                                            to another          Care Information
                                                            location    on the Centre
      graphic
      Rationale: so that the user can precisely place a symbol on the graphic where they

HSCIC Controlled Document

      NwG-0041 – Mandatory

      When the user repositions a symbol ensure that any
      associated annotating text-box and connecting arrow also
      ...
      Prevent the user from adding ready-made symbols outside
      of the graphic perimeter
      Rationale: ready-made symbols only have relevance and meaning when they are
      placed on or inside a graphic

   Usage Examples

   In this incorrect example the user has been able         In this incorrect example the ready-made symbol
   to position the ready-made symbol outside of the         cannot be placed outside of the graphic edge
   graphic edge (NwG-0036)                                  (NwG-0036)
...
HSCIC Controlled Document
      ...
      Provide the functionality for the user to delete any ready-
      made symbols or hand-drawn symbols that they have made
      ...
      When the user does delete any ready-made symbols or
      hand-drawn symbols ensure that the associated annotating
      text-box and connecting arrow are also correspondingly
      deletedfirstly, so that the symbol and its associated items are deleted in one step
     Rationale:
...
HSCIC Controlled Document
      ...
      Allow the user to place symbols on top of one another when
      required
      ...
      drawn symbols) on top of each other where applicable

      NwG-0039 – Mandatory

      Ensure that when symbols are placed on top of each other
      ...
      When a ready-made symbol is initially placed onto the
                                                                                               Page 38
      canvas it should be displayed within a bounding box
                        Copyright ©2013 Health and Social Care Information Centre
...
HSCIC Controlled Document
      ...
      The ready-made symbol bounding box should disappear
      when the user drops the symbol into the desired position
      ...
      The ready-made symbol bounding box should be semi-
      transparent
...
HSCIC Controlled Document
   ...
   In this correct example the ready-made                 In this incorrect example the ready-made symbol
   symbol bounding box is semi-transparent                bounding box is not semi-transparent (NwG-0066)
   (NwG-0066)
...
Text Annotations
   This section gives guidance for text used to annotate a graphic.
      ...
      All text to be used to annotate the graphic should be
      contained in a text-box
      Rationale: in order to keep each text annotation clear and distinct from one another

   Usage Examples

   In this correct example the annotating              In this incorrect example the
   text is contained within a text-box                 annotating text is not contained
   (NwG-0042)                                          within a text-box (NwG-0042)

      NwG-0055 – Mandatory
                                                                                             Page 41
      Allow the user to manually add a text-box for general
      comment textCopyright ©2013 Health
                    annotations          and Social
                                  that are          Care Information Centre
                                             not necessarily
      associated with a symbol annotating the graphic

HSCIC Controlled Document

      NwG-0043 – Mandatory

      When the user adds a symbol to the graphic an associated
      text-box and arrow pointing to the symbol should also be
      ...
      Where a text-box has been automatically added because of
      its association to a symbol, automatically place it on the
      correct side of the graphic close to the newly added symbol
      ...
      The arrow used to point to the symbol should look visually
      different and be distinguishable from the line style used in
      other items within the canvas
      Rationale: so that it is clear that any arrows that cross the graphic are not part of the   Page 42
      graphic image or any other items (i.e. ready-made symbols, hand-drawn symbols)
                         Copyright ©2013 Health and Social Care Information Centre
...
HSCIC Controlled Document
      ...
      The text-box should not be placed on top of any existing
      items within the canvas
...
HSCIC Controlled Document
   ...
   In this correct example the text-box is not placed on           In this incorrect example the text-box is
   top of the graphic (NwG-0046)                                   placed on top of the graphic (NwG-0046)

      NwG-0110 – Mandatory

      Always display any added text-boxes. They should not be
      hidden nor in a collapsed state
      ...
      NwG-0109 – Mandatory
                    Copyright
      Do not truncate         ©2013
                       the text     Health
                                  that hasand Social
                                           been      Care Information
                                                  entered    into theCentre
      text-box. All entered text should always be displayed in full

HSCIC Controlled Document

      NwG-0097 – Mandatory

      Allow the user to enter as much text as they want in the
      text-box
      ...
      clinicians would not ‘abuse’ the text-boxes over-filling them with text

      NwG-0048 – Recommended

      Pre-populate the text-box with an initial text message
      informing the user that they can enter some text into the
      text box
      ...
      The initial text message informing the user that they can
                                                                                                  Page 46
      enter some text into the text box should be presented in a
      way that differentiates   it from
                    Copyright ©2013       text
                                     Health and that
                                                SocialaCare
                                                        userInformation
...
HSCIC Controlled Document
      ...
      The text-box should automatically grow in size as the user
      types in text
...
HSCIC Controlled Document
      ...
      Provide a tool for emphasising text entered in the symbol's
      text-box
      ...
      Provide the functionality for the user to be able to delete
      any text-boxes that they have added to the graphic
      Rationale: as users may want to remove any text-annotations that they incorrectly
      made

      NwG-0095 – Mandatory

      When the user does delete a text-box ensure that if it has a
      pointing arrow and any associated symbols that they are
      also correspondingly deleted
      ...
      Where text-boxes have been automatically added because
      of an associated symbol, do not pre-populate the text-box
                                                                                                Page 48
      with any details relating to that symbol
      Rationale: researchCopyright
                           has shown©2013    Health and Social
                                      that pre-populating        Care Information
                                                           the text-box with symbol Centre
                                                                                     details
      ...
      finding may simply be suspected
...
The Toolbar tools & functions
   This section details the guidance for the toolbar tools and functions used when annotating a graphic.
      ...
      The system should be tolerant and offer the user the option
      to undo and redo any changes they make. At a minimum
      there must be one level of redo and undo
      Rationale: to allow the users to go back to a previous state when they make a
      mistake

      NwG-0103 – Mandatory

      Provide a mechanism that allows the user to remove any
      items placed on the graphic
      ...
      Provide a mechanism that allows the user to remove all
      items placed on the graphic in one go, thus returning the
      session to the state when the graphic was originally loaded
      ...
      When the user selects the mechanism to remove all items                                              Page 49
      placed on the graphic in one go, present an alert warning
                    Copyright ©2013 Health and Social Care Information Centre
      the user of the action that they are about to take with the
...
HSCIC Controlled Document
      ...
      Place together in the toolbar those tools and functions that
      ...
      All tools must have an associated text label and a tool tip
      should be displayed when the user hovers over the icon
      ...
      When the user selects a tool for creating hand-drawn
      symbol annotations, change the mouse cursor to reflect the
      chosen tool
...
GUIDANCE POINTS CHECKLIST
   This chapter contains a summary checklist of all of the Noting with Graphics guidance points.
    ...
    ID                Guidance Point                                                           Conformance
                                                                                               Rating

    Noting with Graphics Module (page 12)

    NwG-              When the graphic is loaded for creation or editing purposes,             Mandatory
    0112              display both the canvas (containing the graphic) and the
                      toolbar

    NwG-              When the graphic is loaded for viewing purposes, display only            Mandatory
    0113              the canvas (containing the graphic and notes) and not the
                      toolbar

    NwG-              When the graphic is loaded for viewing purposes, do not allow            Mandatory
    0114              the user to edit or change any part of the annotated graphic

    NwG-              Position the Noting with Graphics module in the relevant                 Recommended
    0016              clinical notes section

    NwG-              The workflow involved in creating an annotated graphic                   Mandatory
    0012              should allow the user to firstly display the desired graphic,
                      then allow the addition of any annotating symbols and then
                      finally the adding of any annotating text

    NwG-              Where the Noting with Graphics module is not displayed fully             Mandatory
    0107              on screen, ensure that the application hosting it provides
                      scrolling to enable the user to view the entire area

    NwG-              When a previously annotated graphic is loaded for viewing                Mandatory
    0116              purposes, display all the added annotations in the same way
                      as when the graphic was created

    Graphics (page 15)

    NwG-              The graphic should be a simple, lined-based image. It should             Mandatory
    0001              not include any complex details or shaded or coloured areas

    NwG-              The graphic should only be in greyscale. Coloured graphics               Mandatory
    0002              should not be included

    NwG-              Include a title on each displayed graphic where there is the             Mandatory
    0088              chance of selecting the wrong one

    NwG-              Include orientation labels on graphics where there is the                Mandatory
    0008              chance of mixing up the orientation
...
HSCIC Controlled Document
    ...
    NwG-              Where the clinical context requires it, display the correct        Recommended
    0004              graphic taking into account the age of the patient (e.g. display
                      either an adult, teenager, child, infant or baby graphic)

    NwG-              Where the clinical context requires it, display the correct        Recommended
    0087              graphic taking into account the sex of the patient (e.g. display
                      either a male or female graphic)

    NwG-              When opened in the canvas, the graphic should be displayed         Mandatory
    0003              at a suitable size to remove the need for the user having to
                      firstly re-size it

    NwG-              Do not include background lines or grids as part of the graphic    Mandatory
    0009

    NwG-              Where a graphic is made up of 2 or more separate images (e.g.      Recommended
    0006              a full-body graphic made up of a front and rear body image)
                      then provide space for the user to add text annotations
                      between the images

    NwG-              Do not allow a user to delete any part of a graphic                Mandatory
    0010

    NwG-              If re-positioning of a graphic in the canvas is implemented,       Mandatory
    0011              ensure that the location of any items already annotating the
                      graphic is correctly retained

    The Canvas (page 22)

    NwG-              Do not include background lines or grids on the canvas             Mandatory
    0089

    NwG-              Upon loading, display the graphic centrally in the canvas          Mandatory
    0090

    NwG-              Leave sufficient room for adding annotating text to both the       Mandatory
    0005              left and right side of the graphic

    NwG-              Do not leave room above or below the graphic for text              Recommended
    0007              annotating

    NwG-              Only permit one single graphic to be displayed on the canvas       Recommended
    0021

    NwG-              Any colour chosen for the canvas background should not             Mandatory
    0081              reduce the readability or clarity of the graphic, or any
                      annotating items placed on the graphic

    NwG-              A canvas can never be empty or blank – it must always contain      Mandatory
    0099              a graphic
...
HSCIC Controlled Document
    ...
    NwG-              The canvas should be sufficiently sized to contain the graphic      Mandatory
    0091              without the user needing to scroll or zoom to view the entire
                      graphic

    NwG-              The canvas should automatically grow in length when                 Mandatory
    0083              additional room for text or symbol annotations is required

    NwG-              Do not allow the graphic or annotating items to be placed           Mandatory
    0100              outside of the canvas

    NwG-              Do not allow vertical scrolling within the canvas                   Mandatory
    0101

    NwG-              Do not allow horizontal scrolling within the canvas                 Mandatory
    0102

    NwG-              Where the canvas is not displayed fully on screen, ensure that      Mandatory
    0108              the 'look ahead' identifier is shown to indicate that not all
                      content is currently being displayed

    Loading and Searching for a Graphic (page 31)

    NwG-              Where the clinical context requires it, the canvas containing a     Mandatory
    0013              graphic should be automatically loaded in the relevant
                      location in the clinical notes without requiring any user
                      intervention

    NwG-              Where the clinical context requires it, provide the user with an    Mandatory
    0014              option to load a graphic in the relevant location in the clinical
                      notes when required

    NwG-              Where the clinical context requires it, provide a way for the       Mandatory
    0023              user to choose and load the appropriate graphic for the
                      patient case in hand

    NwG-              Where the clinical context allows it, provide the user with a       Recommended
    0018              mechanism that allows them to remove the entire Noting with
                      Graphics module if they decide that they do not want to use a
                      graphic within the clinical notes

    NwG-              Where the clinical context requires it, present the user a short    Mandatory
    0024              list of commonly used graphics to choose from when required

    NwG-              Where the clinical context requires it, allow as a secondary        Mandatory
    0026              way of choosing a graphic the user to perform a simple text-
                      entry keyword search

    NwG-              Where different ways of selecting or searching for a graphic        Recommended
    0027              are implemented, ensure that they are visually distinct and
                      separate from each other on screen
...
HSCIC Controlled Document
    ...
    Symbol Annotations (page 35)

    NwG-              Provide free-hand drawing tools that allow the user to            Mandatory
    0028              annotate the graphic by drawing on it the relevant clinical
                      findings

    NwG-              Where clinical finding symbols are difficult to draw free-hand,   Mandatory
    0029              provide the user with a ready-made symbol that can be simply
                      added to the graphic

    NwG-              Where clinical finding symbols are very common or regularly       Mandatory
    0030              used, provide the user with a ready-made symbol to add to
                      the graphic

    NwG-              The ready-made symbols available for annotating should be         Mandatory
    0032              relevant to the graphic that has been loaded

    NwG-              Provide an easily understood and intuitive way of adding the      Mandatory
    0031              ready-made symbols to the graphic

    NwG-              Ensure that any ready-made symbols provided are correctly         Mandatory
    0111              sized for the graphic they are to be placed on top off

    NwG-              Provide the user with a small set of ready-made symbols -         Mandatory
    0033              limited to only those that are commonly used

    NwG-              Provide a ready-made symbol to indicate an exact location on      Mandatory
    0092              the graphic

    NwG-              Provide a free-hand drawing or shading tool to indicate a         Mandatory
    0034              region or spread-out area

    NwG-              Ensure that the ready-made symbols provided look visually         Mandatory
    0105              different and are distinguishable from all other items within
                      the canvas

    NwG-              Ensure that when used the hand-drawn symbols provided look        Mandatory
    0106              visually different and are distinguishable from all other items
                      within the canvas

    NwG-              Allow the user to make free-hand drawings outside of the          Mandatory
    0035              graphic perimeter (but still within the canvas)

    NwG-              Enable the user to be able to reposition a symbol that they       Mandatory
    0040              have added to the graphic to another location on the graphic

    NwG-              When the user repositions a symbol ensure that any                Mandatory
    0041              associated annotating text-box and connecting arrow also
                      move correspondingly
...
HSCIC Controlled Document
    ...
    0036              the graphic perimeter

    NwG-              Provide the functionality for the user to delete any ready-       Mandatory
    0093              made symbols or hand-drawn symbols that they have made

    NwG-              When the user does delete any ready-made symbols or hand-         Mandatory
    0094              drawn symbols ensure that the associated annotating text-box
                      and connecting arrow are also correspondingly deleted

    NwG-              Allow the user to place symbols on top of one another when        Mandatory
    0038              required

    NwG-              Ensure that when symbols are placed on top of each other          Mandatory
    0039              that they are visually distinguishable

    NwG-              When a ready-made symbol is initially placed onto the canvas      Mandatory
    0064              it should be displayed within a bounding box

    NwG-              The ready-made symbol bounding box should disappear when          Mandatory
    0065              the user drops the symbol into the desired position

    NwG-              The ready-made symbol bounding box should be semi-                Mandatory
    0066              transparent

    Text Annotations (page 46)

    NwG-              All text to be used to annotate the graphic should be             Mandatory
    0042              contained in a text-box

    NwG-              Allow the user to manually add a text-box for general             Mandatory
    0055              comment text annotations that are not necessarily associated
                      with a symbol annotating the graphic

    NwG-              When the user adds a symbol to the graphic an associated          Mandatory
    0043              text-box and arrow pointing to the symbol should also be
                      automatically added to the canvas

    NwG-              Where a text-box has been automatically added because of its      Mandatory
    0045              association to a symbol, automatically place it on the correct
                      side of the graphic close to the newly added symbol

    NwG-              The arrow used to point to the symbol should look visually        Mandatory
    0086              different and be distinguishable from the line style used in
                      other items within the canvas

    NwG-              When a text-box is newly added to the canvas ensure that it       Recommended
    0053              looks visually different to one that has been edited

    NwG-              The text-box should not be placed on top of any existing items    Mandatory
    0046              within the canvas
...
HSCIC Controlled Document
    ...
    0110              hidden nor in a collapsed state

    NwG-              A newly added text-box should have the cursor focus               Mandatory
    0047

    NwG-              Do not truncate the text that has been entered into the text-     Mandatory
    0109              box. All entered text should always be displayed in full

    NwG-              Allow the user to enter as much text as they want in the text-    Mandatory
    0097              box

    NwG-              Pre-populate the text-box with an initial text message            Recommended
    0048              informing the user that they can enter some text into the text
                      box

    NwG-              The initial text message informing the user that they can enter   Recommended
    0115              some text into the text box should be presented in a way that
                      differentiates it from text that a user enters

    NwG-              The text-box should automatically grow in size as the user        Mandatory
    0050              types in text

    NwG-              Provide a tool for emphasising text entered in the symbol's       Recommended
    0051              text-box

    NwG-              Provide the functionality for the user to be able to delete any   Mandatory
    0052              text-boxes that they have added to the graphic

    NwG-              When the user does delete a text-box ensure that if it has a      Mandatory
    0095              pointing arrow and any associated symbols that they are also
                      correspondingly deleted

    NwG-              Where text-boxes have been automatically added because of         Mandatory
    0098              an associated symbol, do not pre-populate the text-box with
                      any details relating to that symbol

    The Toolbar tools & functions (page 55)

    NwG-              The user must be given the option to undo any changes they        Mandatory
    0067              make whilst annotating the graphic. There should be as a
                      minimum 1 level of undo

    NwG-              Provide a mechanism that allows the user to remove any            Mandatory
    0103              items placed on the graphic.

    NwG-              Provide a mechanism that allows the user to remove all items      Mandatory
    0069              placed on the graphic in one go, thus returning the session to
                      the state when the graphic was originally loaded.

    NwG-              When the user selects the mechanism to remove all items           Mandatory
    0070              placed on the graphic in one go, present an alert warning the
                      user of the action that they are about to take with the options
                                                                                               Page 56
...
HSCIC Controlled Document
    ...
    NwG-              Place together in the toolbar those tools and functions that      Mandatory
    0075              are related to each otherLogically group the tools and
                      functions together in the toolbar.

    NwG-              All tools must have an associated text label and a tool tip       Recommended
    0076              should be displayed when the user hovers over the icon with
                      their mouse cursor.

    NwG-              When the user selects a tool for creating hand-draw symbol        Mandatory
    0104              annotations change the mouse cursor to reflect the chosen
                      tool.
