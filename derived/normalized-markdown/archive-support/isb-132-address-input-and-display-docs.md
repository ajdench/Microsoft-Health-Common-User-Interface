# isb-132-address-input-and-display-docs

## Provenance
- Source file: `raw/sources/references/nhs-archives/isb-standards/docs-pages/isb-132-address-input-and-display-docs.html`
- Extracted text: `derived/extracted-text/archive-support/isb-132-address-input-and-display-docs.txt`
- Normalization note: HTML text extraction using a conservative parser; archive boilerplate may remain.

## Extracted Text

DSCN 01/2010 Initial Standard
...
The standard is published in the CUI portal as Address Input and Display v3.1.0.0. The site requires registered access.

Supporting Information

Submission (PDF, 182 Kb)

Development Approach (PDF, 256 Kb)

Clinical Safety Case (PDF, 819 Kb)

Board Output (PDF, 128 Kb)

Design Guide (PDF, 1.8Mb)

Quick Implementation Guide (PDF, 295Kb)
