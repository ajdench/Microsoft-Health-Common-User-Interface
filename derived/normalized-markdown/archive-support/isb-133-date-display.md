...
## Provenance
- Source file: `raw/sources/references/nhs-archives/isb-standards/isb-133-date-display.html`
- Extracted text: `derived/extracted-text/archive-support/isb-133-date-display.txt`
- Normalization note: HTML text extraction using a conservative parser; archive boilerplate may remain.

## Extracted Text

ISB 1503 - Common User Interface - Date Display - Standards Library - ISB
...
Standard ISB 1503
 ...
 Title
 Common User Interface - Date Display

 Description

This user interface standard defines the valid display values for single precise dates in short and long date format.

 Applies To

IT systems that display date data.
