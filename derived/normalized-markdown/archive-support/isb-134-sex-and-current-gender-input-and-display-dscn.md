# isb-134-sex-and-current-gender-input-and-display-dscn

## Provenance
- Source file: `raw/sources/references/nhs-archives/isb-standards/dscn-pdfs/isb-134-sex-and-current-gender-input-and-display-dscn.pdf`
- Extracted text: `derived/extracted-text/archive-support/isb-134-sex-and-current-gender-input-and-display-dscn.txt`
...
Sponsoring Organisation:                                Implementation Date:    01 December 2015
                                                        Subject:
     DH Informatics                                     Sex and Current Gender Input and
                                                        Display for Clinical Systems within the
      Directorate                                       NHS in England
...
Summary:
This user interface standard defines the valid terms and values for sex and current gender, labelling of
information, layout and structure of the control and input field sizes.

Organisations developing or upgrading applications for which the standard is in scope MAY implement
the sex and current gender input and display standard immediately and SHOULD do so at their next
major system release. All clinical systems within the NHS in England MUST conform to the sex and
current gender input and display standard by 01 December 2015.

Patient safety risks associated with the sex and current gender input and display standard are specified
in the safety case accompanying the standard. Organisations that develop, supply, deploy and use
clinical systems must identify and manage any risks in current systems and mitigate implementation risks
for which responsibility for mitigation has been transferred to the supplying or deploying organisation.
The process for managing safety risks is detailed in NHS information standards for the application of
...
Reference No:                    DSCN 05/2010
Version No:                      1.0
Subject:                         Sex and Current Gender Input and Display for Clinical Systems
...
Business Justification:          To make display, input and user interaction consistent across all
 ...
 This user interface standard defines the valid terms and values for sex and current gender, labelling
 of information, layout and structure of the control and input field sizes.
 ...
 Clinical and healthcare applications input and display a patient's current gender or sex in various
 contexts. Users may confuse the terms current gender and sex, or assume that they are
 synonymous. Therefore, it is essential that all clinical and healthcare applications display and explain
 current gender and sex terminology and values in a clear and consistent manner.

 The sex and current gender CUI standard and guidance details the recommendations for entering
 and displaying current gender and sex in clinical and healthcare systems. It aims to enhance
 readability, ensure consistency and to cover all possible variants of sex and current gender.
 Additionally, the design guide enables clinical and healthcare systems to display a predefined,
 restricted set of unknown or unspecified sex and current gender values.




DSCN 05/2010                                                                               Page 2 of 4
 Details of the Standard
 ...
 The following items are covered in the guidance:
    ...
    Defining the valid values for sex and current gender.
    Labelling of information, including:
       o Definition of the terms sex and current gender.
       o Definition of the values.
       o How items of information are to be labelled.
 ...
 Safety Case
 Clinical safety requirements and objectives related to the input and display of sex and current gender
 in clinical systems are documented in the safety case that accompanies this standard
...
Superseded Date (of prior standard)
 ...
 Further Information and Support
         CUI Sex and Current Gender Input and Display Design Guide - www.cui.nhs.uk
