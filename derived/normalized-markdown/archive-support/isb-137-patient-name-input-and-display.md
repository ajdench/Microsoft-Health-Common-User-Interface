...
## Provenance
- Source file: `raw/sources/references/nhs-archives/isb-standards/isb-137-patient-name-input-and-display.html`
- Extracted text: `derived/extracted-text/archive-support/isb-137-patient-name-input-and-display.txt`
- Normalization note: HTML text extraction using a conservative parser; archive boilerplate may remain.

## Extracted Text

ISB 1506 - Common User Interface - Patient Name Input and Display - Standards Library - ISB
...
Standard ISB 1506
 ...
 Title
 Common User Interface - Patient Name Input and Display

 Description

This user interface standard defines the valid values for input and display of patient names, definition of patient name elements and values, how items of information are to be labelled, the layout and structure of the control and input field sizes.

 Applies To

IT systems that capture or display patient demographics.
