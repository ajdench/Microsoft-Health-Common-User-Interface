# isb-137-patient-name-input-and-display-dscn

## Provenance
- Source file: `raw/sources/references/nhs-archives/isb-standards/dscn-pdfs/isb-137-patient-name-input-and-display-dscn.pdf`
- Extracted text: `derived/extracted-text/archive-support/isb-137-patient-name-input-and-display-dscn.txt`
...
Sponsoring Organisation:                                Implementation Date:    01 December 2015
                                                        Subject:
     DH Informatics                                     Patient Name Input and Display for
...
Summary:
This user interface standard defines the valid values for input and display of patient names, definition of
patient name elements and values, how items of information are to be labelled, the layout and structure
of the control and input field sizes.

Organisations developing or upgrading applications for which the standard is in scope MAY implement
the patient name input and display standard immediately and SHOULD do so at their next major system
release. All clinical systems within the NHS in England MUST conform to the patient name input and
display standard by 01 December 2015.

Patient safety risks associated with the patient name input and display standard are specified in the
...
Reference No:                    DSCN 04/2010
Version No:                      1.0
Subject:                         Patient Name Input and Display for Clinical Systems within the
                                 NHS in England
...
Business Justification:          To make display, input and user interaction consistent across
 ...
 This user interface standard defines the valid values for input and display of patient names, definition
 of patient name elements and values, how items of information are to be labelled, the layout and
 structure of the control and input field sizes.
 ...
 Background
 Patient names are displayed in multiple places within clinical and healthcare applications. One
 example is in a patient banner, where unambiguous patient name display enhances patient safety
 and application usability by:

        Ensuring the display of the patient name in a consistent and clear manner that is easy to read,
        and clearly distinguishes name elements.
 ...
 goal in itself, and the primary aim of the standard.

 Having a consistent layout and set of values for the input and display of data items in clinical systems
 makes the design and development of such systems safer, easier and quicker.
...
 The following items are covered in the guidance:
    ...
    Labelling of information, including:
       o Definition of the elements of a patient name.
       o Definition of the values for each element.
 ...
 Safety Case
 Clinical safety requirements and objectives related to the input and display of patient names in clinical
...
 Effects on Other Information Standards:
 ...
 Further Information and Support
         CUI Patient Name Input and Display Design Guide – www.cui.nhs.uk
