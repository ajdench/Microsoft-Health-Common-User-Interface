...
## Provenance
- Source file: `raw/sources/references/nhs-archives/isb-standards/isb-141-date-and-time-input.html`
- Extracted text: `derived/extracted-text/archive-support/isb-141-date-and-time-input.txt`
- Normalization note: HTML text extraction using a conservative parser; archive boilerplate may remain.

## Extracted Text

ISB 1502 - Common User Interface - Date and Time Input - Standards Library - ISB
...
Standard ISB 1502
 ...
 Title
 Common User Interface - Date and Time Input

 Description

This user interface standard defines the valid input rules for fully specified dates and time, partially specified dates, approximate dates and times, arithmetic shortcuts, date and time durations, free text fields, controls and disambiguation of date entries.

 Applies To

IT systems that capture date and time.
