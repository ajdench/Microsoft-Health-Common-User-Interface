# isb-139-time-display-docs

## Provenance
- Source file: `raw/sources/references/nhs-archives/isb-standards/docs-pages/isb-139-time-display-docs.html`
- Extracted text: `derived/extracted-text/archive-support/isb-139-time-display-docs.txt`
- Normalization note: HTML text extraction using a conservative parser; archive boilerplate may remain.

## Extracted Text

DSCN 08/2010 Initial Standard
...
The standard is published in the CUI portal as Time Display v4.0.0.0. The site requires registered access.
...
Design guide (PDF, 337Kb)

Quick implementation guide (PDF, 558Kb)
