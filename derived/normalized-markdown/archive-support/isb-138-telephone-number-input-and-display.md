...
## Provenance
- Source file: `raw/sources/references/nhs-archives/isb-standards/isb-138-telephone-number-input-and-display.html`
- Extracted text: `derived/extracted-text/archive-support/isb-138-telephone-number-input-and-display.txt`
- Normalization note: HTML text extraction using a conservative parser; archive boilerplate may remain.

## Extracted Text

ISB 1508 - Common User Interface - Telephone Number Input and Display - Standards Library - ISB
...
Standard ISB 1508
 ...
 Title
 Common User Interface - Telephone Number Input and Display

 Description

This user interface standard defines the valid values for input and display of telephone numbers, definition of telephone number elements and values, how items of information are to be labelled, the layout and structure of the control and input field sizes.

 Applies To

IT systems that capture or display telephone numbers.
