# isb-136-patient-banner-dscn

## Provenance
- Source file: `raw/sources/references/nhs-archives/isb-standards/dscn-pdfs/isb-136-patient-banner-dscn.pdf`
- Extracted text: `derived/extracted-text/archive-support/isb-136-patient-banner-dscn.txt`
...
Sponsoring Organisation:
                                                        Subject:
    DH Informatics                                      Patient Banner for Clinical Systems
...
and subsequently approved having met the required conditions.

Summary:
This user interface standard specifies the minimum items of information that must be contained in a
patient banner, how this information should be grouped, laid out and labelled, the size of the patient
banner and where it should be located on computer screens. It applies to user interfaces displayed
on desktop or laptop computers.

Organisations developing or upgrading applications for which the standard is in scope MAY
implement the patient banner standard immediately and SHOULD do so at their next major system
release. All clinical systems within the NHS in England MUST conform to the patient banner standard
by 01 December 2015.

Patient safety risks associated with the patient banner are specified in the safety case accompanying
the standard. Organisations that develop, supply, deploy and use clinical systems must identify and
manage any risks in current systems and mitigate implementation risks for which responsibility for
mitigation has been transferred to the supplying or deploying organisation. The process for managing
safety risks is detailed in NHS information standards for the application of patient safety risk
...
 AN 36/2007 - Patient Banner for Clinical Systems in the NHS in England.
 DSCN 01/2010 – Address Input and Display for Clinical Systems within the NHS in England.
 DSCN 03/2010 – NHS Number Input and Display for Clinical Systems within the NHS in England.
 DSCN 04/2010 – Patient Name Input and Display for Clinical Systems within the NHS in England.
 DSCN 05/2010 – Sex & Current Gender Input and Display for Clinical Systems within the NHS in England.
 DSCN 06/2010 – Telephone Number Input and Display for Clinical Systems within the NHS in England.
 DSCN 07/2010 – Date Display for Clinical Systems within the NHS in England.
 DSCN 08/2010 – Time Display for Clinical Systems within the NHS in England.
 DSCN 04/2009 – Patient Identifiers for Identity Bands.
...
Reference No:                    DSCN 09/2010
Version No:                      1.0
Subject:                         Patient Banner for Clinical Systems within the NHS in England
Type of Change:                  Introduction of a new approved Information Standard
Implementation Date:             01 December 2015

Business Justification:          Reducing clinical safety risks by addressing patient safety
                                 requirements for clinical systems related to the identification of
                                 patients.


 Introduction
 The patient banner is an integral part of the user interface in all systems used to support direct care
 of patients and service users. It provides key information that identifies the patient, such as name and
 date of birth, amongst others. It sits within the context of a wider clinical application, and is matched
 with the patient themselves, by asking them (or a third party, such as a parent) to confirm responses,
 usually in their presence or over the telephone. The banner is also matched with any of the patient’s
 associated artefacts, such as samples, letters, specimens, and X-rays.

 This user interface standard specifies the minimum items of information that must be contained in a
 patient banner, how this information should be grouped, laid out and labelled, the size of the patient
 banner and where it should be located on computer screens.

 The standard has been developed as part of the Common User Interface (CUI) programme within the
 Technology Office of Department of Health Informatics Directorate. This programme is addressing
 the safety risks posed by variation across the NHS in the way information is input and displayed. Its
 aim is to support healthcare IT users in correctly inputting and interpreting information relating to all
 aspects of patient care and management.

 Background
 The reduction and (where possible) elimination of errors in the identification of patients is central to
 the improvement of patient safety in the NHS. The National Patient Safety Agency (NPSA) has
 reported that when errors do occur, they are typically one of three main types:

 1.    Failure to identify the patient from their medical record
 2.    Failure to match them correctly with their artefacts (samples, letters, specimens, X-rays etc)
 3.    Failure in communication between staff, or staff not performing checking procedures correctly.

 This standard is concerned with each of the errors identified above, but particularly (1) and (2). It
 defines:

      The clinical safety risks associated with not having a common patient banner for identification.
      The minimum data set for patient identification and how and where these elements should be
       displayed on a patient banner.
...
DSCN 09/2010                                                                                Page 2 of 4
 The following items are covered in the guidance:
     The minimum items of information that must be contained in a patient banner in order to identify
     the patient, i.e. patient name, NHS Number and date of birth, as recommended by the NPSA.
     Grouping and layout of this information
     Labelling of information
     Location and shape of the patient banner
     Size of the patient banner.

 Aspects that are out of scope:
    Reduced-size form factors
    Display of components with separate display standards
    Input of information
    Data storage
    Display styles.

 Safety Case
 Clinical safety requirements and objectives related to the patient banner in clinical systems are
 ...
 Timescales for Implementation
          ...
          FR AM EW O RK                                        Organisation         IT Suppliers
           ...
           Effective Date                   Immediate           Immediate            Immediate
               “may use”

        Implementation Date              When available in     At next major       At next major
               “must use”                    system           system release      system release

         Conformance Date                01 December 2015    01 December 2015   01 December 2015
“must be used effectively and assessed
               for use”

Superseded Date (of prior standard)        Not applicable      Not applicable      Not applicable
     “stop using prior standard”




DSCN 09/2010                                                                            Page 3 of 4
 Effects on Other Information Standards:
 ...
 Further Information and Support
         CUI Patient Banner Design Guide - www.cui.nhs.uk
