...
## Provenance
- Source file: `raw/sources/references/secondary/digitalhealth-microsoft-recognises-emis-careworks-2009.html`
- Extracted text: `derived/extracted-text/reference-context/digitalhealth-microsoft-recognises-emis-careworks-2009.txt`
- Normalization note: HTML text extraction using a conservative parser; boilerplate and navigation chrome may remain.

## Extracted Text

Microsoft recognises EMIS and CareWorks | Digital Health
...
Prev News
EU issues telemedicine update

Next News
 King’s picks McKesson whiteboard system
