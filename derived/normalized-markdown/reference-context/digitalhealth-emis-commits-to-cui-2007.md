# EMIS becomes first GP supplier to commit to CUI

## Provenance
- Source file: `raw/sources/references/secondary/digitalhealth-emis-commits-to-cui-2007.html`
- Extracted text: `derived/extracted-text/reference-context/digitalhealth-emis-commits-to-cui-2007.txt`
- Normalization note: HTML text extraction using a conservative parser; boilerplate and navigation chrome may remain.

## Extracted Text

EMIS becomes first GP supplier to commit to CUI | Digital Health
...
Prev News
Chesterfield Foundation Trust gets SRC digital dictation
...
Subscribe To Our Newsletters
 ...
 The Patients Association has called for more transparency around the use of AI in healthcare in response to the MHRA's call for evidence.
